...
def convert_instance_norm(ctx):
    ...
    if not use_input_stats:
        ...
        result_trt = _add_scale_1d2d3d(ctx.network, input_trt, trt.ScaleMode.CHANNEL, offset, scale, power)
    ...
    # CASE 2 - USING INPUT STATS
        ...
        keep_dims   = True
        reduce_axes = torch_dim_to_trt_axes(tuple(range(2, len(input.shape))), input.dim())
