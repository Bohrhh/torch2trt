...
class ModuleTest(object):
    def __init__(self, module_fn, dtype, device, input_shapes, alphabet=None, **torch2trt_kwargs):
...
def add_module_test(dtype, device, input_shapes, alphabet=None, enabled=True, **torch2trt_kwargs):
    def register_module_test(module):
        global MODULE_TESTS
        MODULE_TESTS += [ModuleTest(module, dtype, device, input_shapes, alphabet=alphabet, **torch2trt_kwargs)]
        return module
