...
@add_module_test(torch.float32, torch.device('cuda'), [(1, 10, 3, 4)], enabled=trt_version() >= '7.0', dynamic_axes={0:[1,32], 2:[3,30], 3:[4,40]})
def test_batch_norm_2d_dynamic():
    return torch.nn.BatchNorm2d(10)

@add_module_test(torch.float32, torch.device('cuda'), [(1, 10, 3, 4, 5)], enabled=trt_version() >= '7.0', dynamic_axes={0:[1,32], 2:[3,30], 3:[4,40], 4:[5,50]})
...
@add_module_test(torch.float32, torch.device('cuda'), [(1, 10, 224)], enabled=trt_version() >= '7.0', dynamic_axes={0:[1,32], 2:[128,256]})
...
def test_max_d1_dynamic():
    return TestInterface(lambda x: torch.max(x, 1, keepdim=False))
...
@add_module_test(torch.float32, torch.device('cuda'), [(1, 3)], dynamic_axes={0:[1,32], 1:[3,30]})
@add_module_test(torch.float32, torch.device('cuda'), [(1, 3, 3)], dynamic_axes={0:[1,32], 1:[3,30], 2:[3,30]})
def test_min_d1_dynamic():
    return TestInterface(lambda x: torch.min(x, 1, keepdim=False))
...
@add_module_test(torch.float32, torch.device('cuda'), [(1, 3, 244, 244)])
def test_rmul_int():
