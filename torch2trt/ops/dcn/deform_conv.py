...
class DeformConvPack(DeformConv):
    """A Deformable Conv Encapsulation that acts as normal Conv layers. DCN
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if version is not None and version > 1:
            print(f'DeformConvPack {prefix.rstrip(".")} is upgraded to version 2.')
...
class ModulatedDeformConvPack(ModulatedDeformConv):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if version is not None and version > 1:
            print(f'ModulatedDeformConvPack {prefix.rstrip(".")} is upgraded to version 2.')
